#############################################################################
# Makefile for building: goatcheese-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu Mar 22 00:38:05 2018
# Project:  goatcheese-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile goatcheese-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DENABLE_WALLET -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_UPNP=1 -DMINIUPNP_STATICLIB -DSTATICLIB -DHAVE_BUILD_INFO -DLINUX -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /home/goat/Desktop/GoatCheese/src/leveldb/libleveldb.a /home/goat/Desktop/GoatCheese/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lz -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
$(TARGET): /home/goat/Desktop/GoatCheese/src/leveldb/libleveldb.a /home/goat/Desktop/GoatCheese/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: goatcheese-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile goatcheese-qt.pro
...
/home/goat/Desktop/GoatCheese/src/leveldb/libleveldb.a: FORCE
	cd /home/goat/Desktop/GoatCheese/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/home/goat/Desktop/GoatCheese/build/build.h: FORCE
	cd /home/goat/Desktop/GoatCheese; /bin/sh share/genbuild.sh /home/goat/Desktop/GoatCheese/build/build.h
...
src/qt/locale/bitcoin_es_AR.qm: src/qt/locale/bitcoin_es_AR.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/bitcoin_es_AR.ts -qm src/qt/locale/bitcoin_es_AR.qm
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/goatcheese_testnet_toolbar.png \
		src/qt/res/icons/goatcheese80.png \
		src/qt/res/icons/key.png \
		src/qt/res/icons/tx_inout.png \
		src/qt/res/icons/remove.png \
		src/qt/res/icons/goatcheese16.png \
		src/qt/res/icons/lock_open.png \
		src/qt/res/icons/goatcheese_testnet.png \
...
build/blake.o: src/obj/x13hash/blake.c src/obj/x13hash/sph_blake.h \
		src/obj/x13hash/sph_types.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/blake.o src/obj/x13hash/blake.c

build/bmw.o: src/obj/x13hash/bmw.c src/obj/x13hash/sph_bmw.h \
		src/obj/x13hash/sph_types.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/bmw.o src/obj/x13hash/bmw.c

build/groestl.o: src/obj/x13hash/groestl.c src/obj/x13hash/sph_groestl.h \
		src/obj/x13hash/sph_types.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/groestl.o src/obj/x13hash/groestl.c

build/jh.o: src/obj/x13hash/jh.c src/obj/x13hash/sph_jh.h \
		src/obj/x13hash/sph_types.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/jh.o src/obj/x13hash/jh.c

build/keccak.o: src/obj/x13hash/keccak.c src/obj/x13hash/sph_keccak.h \
		src/obj/x13hash/sph_types.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/keccak.o src/obj/x13hash/keccak.c

build/skein.o: src/obj/x13hash/skein.c src/obj/x13hash/sph_skein.h \
		src/obj/x13hash/sph_types.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/skein.o src/obj/x13hash/skein.c

build/luffa.o: src/obj/x13hash/luffa.c src/obj/x13hash/sph_luffa.h \
		src/obj/x13hash/sph_types.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/luffa.o src/obj/x13hash/luffa.c

build/cubehash.o: src/obj/x13hash/cubehash.c src/obj/x13hash/sph_cubehash.h \
		src/obj/x13hash/sph_types.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/cubehash.o src/obj/x13hash/cubehash.c

build/shavite.o: src/obj/x13hash/shavite.c src/obj/x13hash/sph_shavite.h \
		src/obj/x13hash/sph_types.h \
		src/obj/x13hash/aes_helper.c
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/shavite.o src/obj/x13hash/shavite.c

build/echo.o: src/obj/x13hash/echo.c src/obj/x13hash/sph_echo.h \
		src/obj/x13hash/sph_types.h \
		src/obj/x13hash/aes_helper.c
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/echo.o src/obj/x13hash/echo.c

build/simd.o: src/obj/x13hash/simd.c src/obj/x13hash/sph_simd.h \
		src/obj/x13hash/sph_types.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/simd.o src/obj/x13hash/simd.c

build/hamsi.o: src/obj/x13hash/hamsi.c src/obj/x13hash/sph_hamsi.h \
		src/obj/x13hash/sph_types.h \
		src/obj/x13hash/hamsi_helper.c
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/hamsi.o src/obj/x13hash/hamsi.c

build/fugue.o: src/obj/x13hash/fugue.c src/obj/x13hash/sph_fugue.h \
		src/obj/x13hash/sph_types.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/fugue.o src/obj/x13hash/fugue.c
