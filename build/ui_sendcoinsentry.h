...
public:
    ...
    void retranslateUi(QFrame *SendCoinsEntry)
    {
        ...
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The address to send the payment to (e.g. SjBj1QvJvsAkU5EBKggdZ8gWc4oK2F5AMY)", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
