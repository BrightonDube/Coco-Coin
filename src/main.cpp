...
#if defined(NDEBUG)
# error "GoatCheese cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "GoatCheese Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight == 1){return PreMine;} else {return 5*COIN;}
}

// miner's coin stake reward
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    return (10 * COIN) + nFees;
}
...
{
    RenameThread("goatcheese-loadblk");
